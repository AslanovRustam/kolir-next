...
const SLIDES: { pill: string; uk: string; en: string; img: string; alt: string; href: string }[] = [
  ...
  },
  {
    ...
    uk: 'Будь у Курсі',
    en: 'Stay Informed',
    img: '/img/slider/bud_y_kursi.webp',
  ...
  },
  {
    ...
    img: '/img/slider/1st_legion.webp',
