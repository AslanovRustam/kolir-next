...
const CASES = [
  {
    ...
    p: 'Сайт «15 кроків до української єдності» — це послідовне знайомство з розвитком нашої країни. Першочергова мета проекту полягає в ознайомленні широких кіл громадськості з історією українського державотворення і у пошуку нових творців для прийдешніх проєктів.',
  ...
  },
  {
    ...
    p: 'українська технологічна компанія, що розробляє та серійно виробляє автономні системи, адаптовані до реальних бойових умов. Ми створюємо цілісну екосистему рішень, де інженерні розробки формуються на основі практичного досвіду їх застосування.',
    site: 'vyriy.com',
    href: '/portfolio',
  ...
  return (
    <section className="hcases" id="cases" aria-label="Портфоліо">
      ...
      <div className="hcases-cta" data-reveal="up">
        <span className="hcases-cta-text">{t('Хочете переглянути всі кейси?')}</span>
