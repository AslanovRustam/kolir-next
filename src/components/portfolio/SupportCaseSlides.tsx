...
const SLIDES: { pill: string; uk: string; en: string; img: string; alt: string; href: string }[] = [
  { pill: 'UI/UX', uk: 'Стрічка', en: 'Strichka', img: '/img/slider/strichka.png', alt: 'Strichka', href: '/portfolio/strichka' },
  { pill: 'UI/UX', uk: '252 ОШБ', en: '252 Assault Battalion', img: '/img/slider/252oshb.png', alt: '252 ОШБ', href: '/portfolio/252b' },
  { pill: 'UI/UX', uk: 'Будь у Курсі', en: 'Stay Informed', img: '/img/slider/bud_y_kursi.png', alt: '15 кроків до єдності', href: '/portfolio/15-krokiv' },
  { pill: 'UI/UX', uk: 'Перший інтернаціональний Легіон', en: 'International Legion', img: '/img/slider/1st_legion.png', alt: 'Перший інтернаціональний Легіон', href: '/portfolio/1st-legion' },
  { pill: 'UI/UX', uk: 'Vyriy Industries', en: 'Vyriy Industries', img: '/img/slider/vyriy.png', alt: 'Vyriy Industries', href: '/portfolio/vyriy' },
